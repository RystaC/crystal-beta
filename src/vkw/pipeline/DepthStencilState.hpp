...
public:
    DepthStencilState(VkBool32 depth_test_enable, VkBool32 depth_write_enable, VkCompareOp compare_op, VkBool32 depth_bounds_test_enable, VkBool32 stencil_test_enable, VkStencilOp front, VkStencilOp back, float min_depth_bounds = 0.0f, float max_depth_bounds = 1.0f) :
        state_(
